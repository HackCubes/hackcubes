// // ADMIN ONLY PAGE - COMMENTED OUT FOR SECURITY
...
//               <span className="text-gray-400">Test Orders API:</span>{' '}
//               <Link href="/api/test-orders" className="text-electric-blue hover:underline">
//                 /api/test-orders
//               </Link>
//             </p>
//             <p className="text-gray-300">
...
// // Placeholder component to prevent 404 errors
// export default function SyncPurchasesPage() {
//   return (
